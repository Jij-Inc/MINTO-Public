...
from minto.v0.experiment.experiment import DatabaseSchema, Experiment
...
def save(experiment: Experiment) -> None:
    ...
    Examples
    ----------
    save [minto.v0.Experiment][minto.v0.experiment.experiment.Experiment] object to a
    file.
    This function is called as a method of
    [minto.v0.Experiment][minto.v0.experiment.experiment.Experiment] object.
    >>> import minto
